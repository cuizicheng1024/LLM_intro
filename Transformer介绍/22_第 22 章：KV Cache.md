...
Original URL: https://www.waylandz.com/llm-transformer-book/第22章-KV-Cache-推理加速/
...
![模型推理过程与矩阵运算](images/ch22-03-kv-cache-autoregressive.jpg)
...
![KV Cache 矩阵运算可视化](images/ch22-02-kv-cache-matrix.jpg)
...
![KV Cache 四个关键点](images/ch22-01-kv-cache-intro.jpg)
...
![不使用 KV Cache 的计算过程](images/ch22-04-without-kv-cache.jpg)
...
![使用 KV Cache 的计算过程](images/ch22-05-with-kv-cache.jpg)
...
![KV Cache 内存占用分析](images/ch22-06-kv-cache-memory.jpg)
...
* **2**：K 和 V 各一份
* **batch**：批处理大小
* **context\_length**：上下文长度
* **n\_layers**：Transformer 层数
* **n\_heads**：注意力头数
* **d\_head**：每个头的维度
* **precision\_bytes**：
  + FP32 = 4 bytes
...
![多轮对话中的 KV Cache](images/ch22-07-kv-cache-multiturn.jpg)
...
![KV Cache 代码实现与速度对比](images/ch22-08-kv-cache-code.jpg)
...
KV Cache 的内存占用随 n\_heads 线性增长。如果有 32 个 attention head，就需要存储 32 组 K 和 32 组 V。能不能让多个 head 共享 K、V 呢？
