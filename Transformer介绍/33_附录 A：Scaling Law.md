...
Original URL: https://www.waylandz.com/llm-transformer-book/附录A-Scaling-Law与计算量估算/
...
对于 L 层、d\_model 维度的 Transformer：
...
* GPT-3 175B：L=96, d\_model=12288
* 估算：12 × 96 × 12288² ≈ 173B ✓

### A.2.3 常见模型参数量

| 模型 | 层数 L | 维度 d\_model | 参数量 |
| --- | --- | --- | --- |
...
2. **参数量估算**：N ≈ 12 × L × d\_model²
3. **计算量估算**：C\_train ≈ 6ND，C\_inference ≈ 2N × tokens
4. **Chinchilla Optimal**：D\_optimal ≈ 20N
5. **成本估算**：
