...
| 模型/API | 默认配置 |
| --- | --- |
| OpenAI GPT | temperature=1.0, top\_p=1.0 |
| Claude | temperature=1.0 |
| LLaMA | temperature=0.6, top\_p=0.9 |
| Mistral | temperature=0.7, top\_k=50 |

### B.8.3 场景推荐

| 场景 | 推荐配置 |
| --- | --- |
| 代码生成 | temperature=0.2, top\_p=0.95 |
| 事实问答 | temperature=0, 或 temperature=0.3 |
| 创意写作 | temperature=0.8-1.0, top\_p=0.9 |
| 对话聊天 | temperature=0.7, top\_p=0.9 |
| 翻译 | beam\_search, beam\_width=4 |
...
| 参数 | 范围 | 效果 |
| --- | --- | --- |
| repetition\_penalty | 1.0-1.5 | 1.0=不惩罚，1.2=常用 |
| presence\_penalty | 0-2.0 | 0=不惩罚，0.6=常用 |
| frequency\_penalty | 0-2.0 | 0=不惩罚，0.5=常用 |
