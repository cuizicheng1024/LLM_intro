...
Original URL: https://www.waylandz.com/llm-transformer-book/第24章-Sparse与Infinite-Attention/
...
![Sparse Attention 介绍](images/ch24-01-sparse-attention-intro.jpg)
...
![BigBird 稀疏模式](images/ch24-04-sparse-bigbird.jpg)
...
![稀疏注意力机制构建步骤](images/ch24-02-sparse-longformer.jpg)
...
![全局注意力与最终稀疏矩阵](images/ch24-03-sparse-sliding-window.jpg)
...
![BigBird 架构](images/ch24-04-sparse-bigbird.jpg)
...
![Linear Attention 原理](images/ch24-08-linear-attention-diagram.jpg)
...
![Efficient Linear Attention 论文](images/ch24-07-linear-attention.jpg)
...
![Infini Attention 对话流程](images/ch24-05-infini-attention-flow.jpg)
...
![Infini-Transformer 架构](images/ch24-06-infini-attention-arch.jpg)
...
无论你处理了 1 万、10 万还是 100 万个 token，memory 矩阵的大小始终是 d\_model x d\_model。

这就像人类的记忆：我们不可能记住生活中的每一个细节，但我们会不断**压缩和更新**我们的记忆，保留最重要的信息。

### 24.6.5 Gemini 1.5：Infini Attention 的实战验证

![Gemini 1.5 与 Infini Attention](images/ch24-09-infini-gemini.jpg)
...
![所有技术组合](images/ch24-10-all-techniques.jpg)
