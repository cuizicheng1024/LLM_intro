...
Original URL: https://www.waylandz.com/llm-transformer-book/第26章-LoRA与QLoRA-高效微调/
...
![LoRA 低秩矩阵分解](images/ch26-01-lora-intro.jpg)
...
![LoRA Rank 参数](images/ch26-02-lora-rank.jpg)
...
| Rank r | val\_loss | BLEU | NIST | METEOR | ROUGE-L | CIDEr |
| --- | --- | --- | --- | --- | --- | --- |
...
3. **val\_loss 在 r >= 16 后趋于稳定**：继续增加 r 没有明显收益
...
![LoRA 公式](images/ch26-03-lora-formula.jpg)
...
![LoRA PEFT 代码](images/ch26-04-lora-peft-code.jpg)
...
| 模型 | 目标模块 |
| --- | --- |
| LLaMA / Mistral | q\_proj, k\_proj, v\_proj, o\_proj, gate\_proj, up\_proj, down\_proj |
| GPT-2 | c\_attn, c\_proj, c\_fc |
...
![QLoRA 介绍](images/ch26-05-qlora-intro.jpg)
...
![QLoRA 公式](images/ch26-06-qlora-formula.jpg)
